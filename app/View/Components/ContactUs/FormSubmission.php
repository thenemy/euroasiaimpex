...
class FormSubmission extends Component
{
    ...
    public function __construct()
    {
        ...
        $name = new Titles("First Name", "Имя", "İsim");
        $last = new Titles("Last Name", "Фамилия", "Soyadı");
        $email = new Titles("Email", "Электроная почти", "Email");
        $subject = new Titles("Subject", "Тема", "Konu");
        $message = new Titles("Message", "Сообщение", "Haberler");
